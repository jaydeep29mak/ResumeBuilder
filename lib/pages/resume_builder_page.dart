import 'package:resumebuilder/pages/personal_info_page.dart';
import 'package:resumebuilder/pages/projects_page.dart';
import 'package:resumebuilder/pages/references_page.dart';
import 'package:resumebuilder/pages/skills_page.dart';
import 'package:resumebuilder/pages/starting_page.dart';
...
class _resume_builder_pageState extends State<resume_builder_page> {
            ...
            Column(
                ...
                children: <Widget>[
                  GridView.count(
                    ...
                    mainAxisSpacing: 20,
                    children: <Widget>[
                      homePageRowCell(FontAwesomeIcons.user, "Personal Info",
                          'PersonalInfo', context),
                      homePageRowCell(FontAwesomeIcons.bullseye, "Objective",
                          'Objective', context),
                      homePageRowCell(FontAwesomeIcons.graduationCap,
                          "Academics", 'Academics', context),
                      homePageRowCell(
                          FontAwesomeIcons.star, "Skills", 'Skills', context),
                      homePageRowCell(FontAwesomeIcons.puzzlePiece, "Interests",
                          'Interests', context),
                      homePageRowCell(FontAwesomeIcons.file, "Projects",
                          'Projects', context),
                      homePageRowCell(FontAwesomeIcons.briefcase, "Experiences",
                          'Experiences', context),
                      homePageRowCell(FontAwesomeIcons.envelope, "Cover Letter",
                          'CoverLetter', context),
                      homePageRowCell(FontAwesomeIcons.addressBook,
  ...
  Widget homePageRowCell(
          var sIcon, String title, String page, BuildContext context) =>
      Container(
